...
- Mitigate cache issues by adding `v` parameter to static file url
- Pass extraStylesheet to fullscreen viewer

## [0.10.2] - 2026-01-07

- Fix `preg_replace` argument in PdfJsController

## [0.10.1] - 2025-12-18

- Fix eventual overflow that happen with HTML media
...
- Clarify that some settings only apply to the full viewer
- Add a new global setting and its site-specific counterpart for showing the
  media selector page block only if there are several media
- Fix "Show download link" setting
...
[0.10.2]: https://github.com/biblibre/omeka-s-module-OctopusViewer/releases/tag/v0.10.2
[0.10.1]: https://github.com/biblibre/omeka-s-module-OctopusViewer/releases/tag/v0.10.1
[0.10.0]: https://github.com/biblibre/omeka-s-module-OctopusViewer/releases/tag/v0.10.0
[0.9.1]: https://github.com/biblibre/omeka-s-module-OctopusViewer/releases/tag/v0.9.1
